/// \ingroup baseCode
/// \class ttk::VietorisRipsComplex 
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK %vietorisRipsComplex processing package.
///
/// %VietorisRipsComplex is a TTK processing package that takes a scalar field on the input 
/// and produces a scalar field on the output.
///
/// \sa ttk::Triangulation
/// \sa vtkVietorisRipsComplex.cpp %for a usage example.

#ifndef _VIETORISRIPSCOMPLEX_H
#define _VIETORISRIPSCOMPLEX_H
...
namespace ttk{
  ...
  class VietorisRipsComplex : public Debug{
    ...
    public:
      ...
      template <class dataType>
        int execute(const double &radius, const bool &option1 , const bool &option2 , const bool &option3) const;
      ...
      /// see the setInput*() functions of ttk::Triangulation). See vtkVietorisRipsComplex 
...
// #include                  <VietorisRipsComplex.cpp>

// template functions
template <class dataType> int VietorisRipsComplex::execute(
  const double &radius, const bool &option1 , const bool &option2 , const bool &option3) const{
...
//  }
  ...
  {
    stringstream msg;
    msg << "[VietorisRipsComplex] Data-set (" << vertexNumber
      << " points) processed in "
